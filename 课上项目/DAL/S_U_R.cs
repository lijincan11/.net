...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public WindowsForms_Student.Model.S_U_R GetModel(string UserID,string RoleID)
		{
			...
			WindowsForms_Student.Model.S_U_R model=new WindowsForms_Student.Model.S_U_R();
		...
		/// 得到一个对象实体
		/// </summary>
		public WindowsForms_Student.Model.S_U_R DataRowToModel(DataRow row)
		{
			WindowsForms_Student.Model.S_U_R model=new WindowsForms_Student.Model.S_U_R();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from S_U_R T ");
