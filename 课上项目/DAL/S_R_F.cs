...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public WindowsForms_Student.Model.S_R_F GetModel(string RoleID,string FunctionID)
		{
			...
			WindowsForms_Student.Model.S_R_F model=new WindowsForms_Student.Model.S_R_F();
		...
		/// 得到一个对象实体
		/// </summary>
		public WindowsForms_Student.Model.S_R_F DataRowToModel(DataRow row)
		{
			WindowsForms_Student.Model.S_R_F model=new WindowsForms_Student.Model.S_R_F();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from S_R_F T ");
