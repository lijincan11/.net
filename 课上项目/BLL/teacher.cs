...
namespace WindowsForms_Student.BLL
{
	...
	{
		private readonly WindowsForms_Student.DAL.teacher dal=new WindowsForms_Student.DAL.teacher();
		public teacher()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WindowsForms_Student.Model.teacher GetModelByCache(string TNo)
		{
			...
			return (WindowsForms_Student.Model.teacher)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WindowsForms_Student.Model.teacher> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WindowsForms_Student.Model.teacher> DataTableToList(DataTable dt)
		{
			List<WindowsForms_Student.Model.teacher> modelList = new List<WindowsForms_Student.Model.teacher>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WindowsForms_Student.Model.teacher model;
